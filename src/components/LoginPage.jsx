        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <p className="text-gray-500 mt-2 text-base">
                {step === 'email' 
                  ? 'Enter your email to start generating high-converting ads.' 
          ...
          <div className="space-y-6">
                ...
                >
                  <div className="space-y-2">
                    ...
                    <div className="relative group">
                      <SafeIcon 
                        icon={FiMail} 
                        className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 group-focus-within:text-black transition-colors z-10" 
                      />
                      <input
                        type="email"
                        value={email}
            ...
            <p className="pt-8 text-center text-xs text-gray-400 leading-relaxed">
              By continuing, you agree to Velos's 
              <br />
              <a href="#" className="underline hover:text-gray-600 mx-1">Terms of Service</a>
              and
              <a href="#" className="underline hover:text-gray-600 mx-1">Privacy Policy</a>.
            </p>
          </div>
        </div>
      </div>
